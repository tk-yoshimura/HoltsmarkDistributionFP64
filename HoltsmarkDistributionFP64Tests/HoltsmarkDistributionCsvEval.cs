...
namespace HoltsmarkDistributionFP64Tests {
    [TestClass()]
    public class HoltsmarkDistributionCsvEval {

        [TestMethod()]
        public void PlotPDF() {
            using StreamReader sr = new("../../../../results/holtsmark_pdf_cpp.csv");
            sr.ReadLine();

            DoubleDoubleStatistic.ContinuousDistributions.HoltsmarkDistribution dist_fp128 = new();
        ...
        public void PlotPDFLimit() {
            using StreamReader sr = new("../../../../results/holtsmark_pdf_limit_cpp.csv");
            sr.ReadLine();
        ...
        public void PlotCDFLower() {
            using StreamReader sr = new("../../../../results/holtsmark_cdf_cpp.csv");
            sr.ReadLine();
        ...
        public void PlotCDFUpperLimit() {
            using StreamReader sr = new("../../../../results/holtsmark_cdf_limit_cpp.csv");
            sr.ReadLine();
        ...
        public void PlotQuantile() {
            using StreamReader sr = new("../../../../results/holtsmark_quantile_cpp.csv");
            sr.ReadLine();
        ...
        public void PlotQuantileLower() {
            using StreamReader sr = new("../../../../results/holtsmark_quantilelower_limit_cpp.csv");
            sr.ReadLine();
        ...
        public void PlotQuantileUpper() {
            using StreamReader sr = new("../../../../results/holtsmark_quantileupper_limit_cpp.csv");
            sr.ReadLine();
