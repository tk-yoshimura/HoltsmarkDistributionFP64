...
namespace HoltsmarkDistributionFP64Tests {
    [TestClass()]
    public class HoltsmarkDistributionSummary {

        static HoltsmarkDistributionSummary() {
        ...
        public void PlotPDF() {
            ...
            HoltsmarkDistributionFP64.HoltsmarkDistribution dist_fp64 = new();
        ...
        public void PlotCDFLower() {
            ...
            for (double x = -6; x <= 64; x += 1d / 1024) {
                double actual = dist_fp64.CDF(x, HoltsmarkDistributionFP64.Interval.Lower);
        ...
        public void PlotCDFUpperLimit() {
            ...
            for (double x0 = 64; x0 <= double.ScaleB(1, 64); x0 *= 2) {
                for (double x = x0; x < x0 * 2; x += x0 / 256) {
                    double actual = dist_fp64.CDF(x, HoltsmarkDistributionFP64.Interval.Upper);
        ...
        public void PlotQuantile() {
            ...
            for (double x = 1d / 8192; x < 1; x += 1d / 8192) {
                double actual = dist_fp64.Quantile(x, HoltsmarkDistributionFP64.Interval.Lower);
        ...
        public void PlotQuantileUpper() {
            ...
            for (double x0 = 1d / 8192; x0 > double.ScaleB(1, -128); x0 /= 2) {
                for (double x = x0; x > x0 / 2; x -= x0 / 256) {
                    double actual = dist_fp64.Quantile(x, HoltsmarkDistributionFP64.Interval.Upper);
